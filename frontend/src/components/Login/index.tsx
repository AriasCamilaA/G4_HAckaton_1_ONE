    ...
    <div className="flex items-center justify-center min-h-screen">
      <div className="flex flex-col gap-4 w-full max-w-md">
        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate>
          ...
          {authState === AuthState.AUTHENTICATION_ERROR && (
            <p className="text-red-500 text-xs mt-1 text-left">Incorrect email or password. Please try again.</p>
          )}
          {authState === AuthState.AUTHENTICATED && (
            <p className="text-green-500 text-xs mt-1 text-left">Logged in successfully!</p>
          )}
        </form>
      </div>
    </div>
